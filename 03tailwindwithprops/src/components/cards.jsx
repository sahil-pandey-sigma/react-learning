...
export default function Card({ userName = "Toxic Boy" }) {
  // we can provide a default value to props also, so that if some one has not passed the props in their implementation then the don't stay without value
